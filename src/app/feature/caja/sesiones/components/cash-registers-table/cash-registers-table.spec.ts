...
describe('CashRegistersTable', () => {
  ...
  beforeEach(async () =>
    TestBed.configureTestingModule({ imports: [CashRegistersTable] }).compileComponents(),
  );

  it('emits selection and the available opening action', () => {
    const fixture = TestBed.createComponent(CashRegistersTable);
    fixture.componentRef.setInput('registers', [register]);
    fixture.detectChanges();
    let selected: CashRegister | undefined;
    ...
    expect(selected).toBe(register);
    expect(opened).toBe(register);
  });

  it('hides administrative editing for workers and blocks already open registers', () => {
    const fixture = TestBed.createComponent(CashRegistersTable);
    fixture.componentRef.setInput('registers', [
      {
        ...register,
        openOpening: {
          id: 2,
